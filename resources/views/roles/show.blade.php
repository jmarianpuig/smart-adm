                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex items-center justify-between">
                            <h4 class="text-xl text-gray-900 dark:text-white font-bold border-b py-3 dark:border-gray-500 mb-4 w-full">
                                ...
                                {{-- <a href="{{ route('roles.create') }}" class="bg-green-500 hover:bg-green-700 text-white text-xs font-bold py-2 px-3 rounded inline-block text-center mx-auto float-right"><i class="fa-solid fa-file-excel"></i> Seleccionados</a> --}}
                            </h4>
                        </div>
                        @php
                            $roleId = $role->id;
                        @endphp
                        <livewire:permissions-table :role='$roleId' />
                    </div>
                </div>
            </div>
        </div>
