<div class="my-4">
    ...
    @php
        $route = match(get_class($data)) {
            App\Models\Actor::class => 'actors.update',
            App\Models\Xtra::class => 'extras.update',
        };
    ...
    <form class="grid gap-4 sm:grid-cols-1 md:grid-cols-2" action="{{ route($route, $data->id) }}" method="POST" enctype="multipart/form-data" id="register">
        @csrf
        @method('patch')
        ...
        <div class="h-fit bg-white dark:bg-gray-700 dark:text-white rounded-lg shadow-xl p-4">
            <div class="flex-1 bg-white dark:bg-gray-700 dark:text-white rounded-lg shadow-xl p-4">
                <h4 class="text-xl text-gray-900 dark:text-white font-bold border-b py-2 dark:border-gray-500">Datos Personales</h4>
                <ul class="mt-2 text-gray-700">
                    ...
                    <li class="flex py-2">
                        ...
                        <input type="text" name="name" class="w-full h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->name }}" minlength="3" maxlength="30" required />
                    </li>

                    {{-- first_lname --}}
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Apellido 1:</span>
                        <input type="text" name="first_lname" class="w-full h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->first_lname }}" minlength="3" maxlength="30" required />
                    </li>

                    {{-- second_lname --}}
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Apellido 2:</span>
                        <input type="text" name="second_lname" class="w-full h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->second_lname }}" minlength="3" maxlength="30" />
                    </li>

                    {{-- Name --}}
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">N. Artístico:</span>
                        <input type="text" name="alias" class="w-full h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->alias }}" minlength="3" maxlength="80" />
                    </li>

                    {{-- Birthdate --}}
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Nacimiento:</span>
                    ...
                    <li class="flex py-2">
                        ...
                        <input type="text" name="dni" id="dni" value="{{ $data->dni }}" placeholder="Falta DNI/NIF" minlength="9" maxlength="9" class="w-full h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" onblur="validateDNI(this.value)" required />
                    </li>
                    @error('dni')
                    <span class="text-sm text-red-700">
                        <strong>{{ $message }}</strong>
            ...
            <div class="flex-1 bg-white dark:bg-gray-700 dark:text-white rounded-lg shadow-xl p-4 mt-4">
                <h4 class="text-xl text-gray-900  dark:text-white font-bold border-b py-2 dark:border-gray-500">Datos de Contacto</h4>
                <ul class="mt-2 text-gray-700">
                    ...
                    <li class="flex py-2">
                        ...
                        <input type="text" class="w-full h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" minlength="9" maxlength="9" name="phone" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" value="{{ $data->phone }}" required />
                    </li>
                    @error('phone')
                    <span class="text-sm text-red-700">
                        <strong>{{ $message }}</strong>
                    ...
                    <li class="flex py-2">
                        ...
                        <input type="text" name="adress" class="w-full h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->adress }}" minlength="5" maxlength="80" />
                    </li>
                    @error('adress')
                    <span class="text-sm text-red-700">
                        <strong>{{ $message }}</strong>
                    ...
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Código
                            Postal:</span>
                        <input type="text" name="zip_code" class="w-full h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->zip_code }}" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" minlength="5" maxlength="5" />
                    </li>
                    @error('zip_code')
                    <span class="text-sm text-red-700">
                        <strong>{{ $message }}</strong>
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="provincia" id="provincia" class="w-full py-0 h-6 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" onchange="getMunicipios()">
                            @php
                            $provincias = \App\Models\Provincia::orderBy('provincia')->get();
                            @endphp
                            <option class="text-gray-700 dark:text-white dark:bg-gray-700 focus:ring-transparent" value="{{ $data->municipio->provincia->id }}" selected="selected">{{ $data->municipio->provincia->provincia }}</option>
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="municipio" id="municipio" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            @php
                            $municipios = \App\Models\Municipio::All();
                            @endphp
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->municipio->id }}" selected="selected">{{ $data->municipio->municipio }}</option>
                        </select>
                    </li>
                    @error('municipio')
                    <span class="text-sm text-red-700">
            ...
            <div class="flex-1 bg-white dark:bg-gray-700 dark:text-white rounded-lg shadow-xl p-4 mt-4">
                ...
                <ul class="mt-2 text-gray-700">
                    <li class="flex py-2">
                        ...
                        <input type="number" min="50" max="220" name="height" class="w-full h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" placeholder="Altura (cm)" value="{{ $data->height }}" required />
                        @error('height')
                        <span class="text-sm text-red-700">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="shirt_size" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            @php
                            $sizes = \App\Models\ShirtSize::all();
                            @endphp
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->shirt_size_id }}" selected="selected">{{ $data->shirt_size->size }}</option>
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="pant_size" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            @php
                            $sizes = \App\Models\PantSize::all();
                            @endphp
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->pant_size_id }}" selected="selected">{{ $data->pant_size->size }}</option>
                            @foreach ($sizes as $size)
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $size->id }}">{{ $size->size }}</option>
                            @endforeach
                        </select>
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="shoe_size" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            ...
                            @endphp
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->shoe_size_id }}" selected="selected">{{ $data->shoe_size->size }}</option>
                            @foreach ($sizes as $size)
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $size->id }}">{{ $size->size }}</option>
                            @endforeach
                        </select>
                ...
                <ul class="mt-2 text-gray-700">
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="study" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            ...
                            @endphp
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->study_id }}" selected="selected">{{ $data->study->study }}</option>
                    ...
                    {{-- Is Retired --}}
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Jubilado/a:</span>
                        <select name="is_retired" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->is_retired }}" selected="selected">{{ $data->formattedIsRetired }}</option>
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="eye_color" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            ...
                            @endphp
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->eye_color_id }}" selected="selected">{{ $data->eye_color->color }}</option>
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="hair_color" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            ...
                            @endphp
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->hair_color_id }}" selected="selected">{{ $data->hair_color->color }}</option>
                            @foreach ($colors as $color)
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $color->id }}">{{ $color->color }}</option>
                            @endforeach
                        </select>
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="race" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            ...
                            @endphp
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->race_id }}" selected="selected">{{ $data->race->race }}</option>
                    ...
                    {{-- Availability --}}
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Disponibilidad:</span>
                        <select name="availability" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            @php
                            $availabilites = \App\Models\Availability::all();
                            @endphp
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->availability_id }}" selected="selected">{{ $data->availability->availability }}</option>
                    ...
                    <li class="flex py-2">
                        ...
                        <select name="has_car" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->has_car }}" selected="selected">{{ $data->formattedHasCar }}</option>
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="0">No</option>
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="1">Sí</option>
                        </select>
                    </li>
                    ...
                    {{-- Is Disabled --}}
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Discapacidad:</span>
                        <select name="is_disabled" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->is_disabled }}" selected="selected">{{ $data->formattedIsDisabled }}</option>
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="0">No</option>
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="1">Sí</option>
                        </select>
                    </li>
                    ...
                    {{-- has tattoos --}}
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Tatuajes:</span>
                        <select name="has_tattoos" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent">
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->has_tattoos }}" selected="selected">{{ $data->formattedHasTattoos }}</option>
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="0">No</option>
                            <option class="text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="1">Sí</option>
                        </select>
                    </li>
                    ...
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Habilidades:</span>
                        <input name="skills" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" type="text" value="{{ $data->skills }}" />
                    </li>
                    @error('skills')
                    <span class="text-sm text-red-700">
                        <strong>{{ $message }}</strong>
                    ...
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Figuración:</span>
                    ...
                    <li class="flex py-2">
                        <span class="font-bold w-32 dark:text-white min-w-[125px] flex-grow-1 flex-shrink-1">Url
                            Book:</span>
                        <input type="text" name="url_book" class="w-full py-0 h-6 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:ring-transparent" value="{{ $data->urlBook }}" />
                    </li>
                    @error('url_book')
                    <span class="text-sm text-red-700">
                        <strong>{{ $message }}</strong>
