<x-app-layout>
    ...
    <div class="w-full mx-auto sm:px-6 lg:px-4">
        <div class="xs:w-full xl:w-7/12 mx-auto sm:p-6 lg:p-6 h-fit bg-white dark:bg-gray-800 dark:text-white rounded-lg shadow-xl p-4 mt-8">
                ...
                <div class="my-4">
                    <div class="grid gap-4 sm:grid-cols-1 md:grid-cols-2">
                        <div class="h-fit bg-white dark:bg-gray-700 dark:text-white rounded-lg shadow-xl p-4">
                            <livewire:data-profile :info="$data" :key="$data->id" />
                        </div>
                        <div class="h-fit bg-white dark:bg-gray-700 dark:text-white rounded-lg shadow-xl p-4">
